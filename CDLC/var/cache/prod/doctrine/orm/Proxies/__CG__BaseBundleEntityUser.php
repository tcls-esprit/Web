 ...
 */
class User extends \BaseBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'BaseBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'BaseBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'BaseBundle\\Entity\\User' . "\0" . 'pwd', '' . "\0" . 'BaseBundle\\Entity\\User' . "\0" . 'ddn', '' . "\0" . 'BaseBundle\\Entity\\User' . "\0" . 'sexe', '' . "\0" . 'BaseBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'BaseBundle\\Entity\\User' . "\0" . 'ci', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
